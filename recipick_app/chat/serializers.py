...
class ChatRoomSerializer(serializers.ModelSerializer):
    ...
    opponent_id = serializers.SerializerMethodField()  # 상대방 아이디 필드를 동적으로 가져옵니다.
    shop_user_id = serializers.SerializerMethodField()  # 상점 사용자의 아이디을 가져오는 필드입니다.
    visitor_user_id = serializers.SerializerMethodField()  # 방문자 사용자의 아이디을 가져오는 필드입니다.
