<template>
    <div class="find-id">
        <img src="@/assets/find-id.png" class="title">
        <form @submit.prevent="submitEmail">
            ...
            <button class="email-button" type="submit">아이디 찾기</button>
...
export default {
    ...
    methods: {
        async submitEmail() {
            try {
                const response = await apiClient.post("user/find-id/", {
                    email: this.email,
                });
    ...
    mounted() {
        document.title = '아이디 찾기 - Recipick'
    },
};
</script>
