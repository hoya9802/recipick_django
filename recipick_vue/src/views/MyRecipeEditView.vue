    ...
    methods: {
        async fetchRecipeDetails() {
            try {
                ...
                this.formData.title = recipe.name;
                this.formData.category = recipe.category;
                this.formData.time_minutes = recipe.time_minutes;
                this.formData.serving = recipe.serving;
                this.formData.link = recipe.link;
                this.formData.description = recipe.description;
                this.selectedIngredients = recipe.ingredients;
                this.previewImage = recipe.image || null;
            } catch (error) {
                console.error("레시피 정보를 불러오는 중 오류 발생:", error);
                alert("레시피 정보를 가져오지 못했습니다.");
            }
        },
        ...
        async submitEdit() {
            try {
                await apiClient.patch(`/recipes/${this.id}/`, {
